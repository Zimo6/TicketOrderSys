...
<form id="form1" name="form1" action="${pageContext.request.contextPath}/user_adminUser.action" method="post">
	<div class="MAIN">
		<ul>
			...
			<li class="topB">
				<span> 
					<a href="http://localhost:8080/TicketOrderSys/flight_indexList.action" target="_blank"><img src="${pageContext.request.contextPath}/image/login/logo.gif" alt="" style="" /></a>
				</span>
			</li>
			<li class="topC"></li>
			<li class="topD">
