...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<a href="${pageContext.request.contextPath}/admin/main.jsp"><img alt="bglogo" src="${pageContext.request.contextPath}/image/bglogo.png"  ></a>
			</td>
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎管理员：</strong>${currentUser.userName }</font>
			</td>
		</tr>
	</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			...
			<div class="flight_css">
			<img alt="飞机背景图" src="${pageContext.request.contextPath}/image/flight.png" width="100%" height="780px" >
			</div>
